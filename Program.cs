...
namespace TugasArray
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Mahasiswa mahasiswa1 = new Mahasiswa(1, "1234", "wildan", 75);
            mahasiswas[0] = mahasiswa1;

            Mahasiswa mahasiswa2 = new Mahasiswa(2, "1235", "hanafi", 80);
            mahasiswas[1] = mahasiswa2;

            Mahasiswa mahasiswa3 = new Mahasiswa(3, "1235", "fiski", 95);
